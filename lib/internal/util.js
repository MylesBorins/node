...
function promisify(original, thisObj) {
  if (typeof original !== 'function')
    throw new ERR_INVALID_ARG_TYPE('original', 'Function', original);

  if (thisObj && typeof thisObj !== 'object')
    throw new ERR_INVALID_ARG_TYPE('thisObj', 'Object', thisObj);
  ...
  function fn(...args) {
    return new Promise((resolve, reject) => {
      original.call(thisObj ? thisObj : this, ...args, (err, ...values) => {
        if (err) {
          return reject(err);
        }
