...
const a = import.meta.require(fixtures.path('module-require', 'relative', 'dot.js'));
const b = import.meta.require(fixtures.path('module-require', 'relative', 'dot-slash.js'));
